...
parser.add_argument("--zRange", dest="mudis_z_range", nargs=2, help="lower and upper z limit of DIS interaction", required=False, default=[-999,999], type=float)
...
if simEngine == "muonDIS":
 ...
 DISgen.SetPositions(options.mudis_z_range[0], options.mudis_z_range[1], options.mudis_x_range[0], options.mudis_x_range[1], options.mudis_y_range[0], options.mudis_y_range[1])
 ...
 print("MuDIS position nfo input:\nx_range =", options.mudis_x_range, "y_range =", options.mudis_y_range, "z_range = ", options.mudis_z_range)
